...
| ------------------------- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `gr4vyId`                 | `null`        | **Required** - The library automatically sets the Api host to `api.<gr4vyId>.gr4vy.app` and Embed UI host to `embed.<gr4vyId>.gr4vy.app` for production and `api.sandbox.<gr4vyId>.gr4vy.app` and `embed.sandbox.<gr4vyId>.gr4vy.app` for the sandbox environment.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `amount`                  | `null`        | **Required** - The amount to authorize or capture in the specified `currency`. only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `currency`                | `null`        | **Required** - A valid, active, 3-character `ISO 4217` currency code to authorize or capture the `amount` for. only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `theme`                   | `null`        | Theme customisation options (See Theming Options)[https://docs.gr4vy.com/guides/payments/embed/theming#theme-options].                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
